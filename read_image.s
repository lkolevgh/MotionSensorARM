...
read_image:
    ...
    loopr:
       ...
       loopc:
          ...
          ldr r1, [fp, #36]  @ loads width into r1
          mul r1, r9, r1  @ r1 = r*width = r1*r9
          add r1, r1, r8  @ r1 = r*width + c
          ldr r2, [fp, #-12]  @ loads r2 <-- B
          @ *(r2 + r1) = r0
